...
Bugsnag.start({
	apiKey: 'ca12fb518eab5da4d4f9dffa3d2c9a76',
	onError: function (event) {
    if(SendosoConfig.ignoreErrors.includes(event.errors[0].errorMessage)) {
      // why ignoring this? https://sendoso.atlassian.net/browse/INTE-2447
      return false;
    }
